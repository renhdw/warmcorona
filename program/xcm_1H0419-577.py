...
OUTPUT_DIR = "~/data/XMM/1H0419-577/0604720301/xcm"

# 两个输出文件名（slab / sphere 各一份）
XCM_SLAB   = "fit_model_Tom_slab_1H0419-577.xcm"
XCM_SPHERE = "fit_model_tv_Tom_sphere_1H0419-577.xcm"
...
params = [
    1,          # zTBabs:nH
    0.10410067, # zTBabs:Redshift (frozen)
    1.14E-2,    # TBabs:nH (frozen)
    1.5,        # nthComp:Gamma
    100,        # nthComp:kT_e
