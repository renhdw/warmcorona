...
OUTPUT_DIR = "~/data/XMM/Q0056-363/0401930101/xcm"

# 两个输出文件名（slab / sphere 各一份）
XCM_SLAB   = "fit_model_Tom_slab_Q0056-363.xcm"
XCM_SPHERE = "fit_model_tv_Tom_sphere_Q0056-363.xcm"
...
params = [
    1,          # zTBabs:nH
    0.16414, # zTBabs:Redshift (frozen)
    1.37E-2,    # TBabs:nH (frozen)
    1.5,        # nthComp:Gamma
    100,        # nthComp:kT_e
