...
# DEFAULTS
# =====================
BASEDIR_DEFAULT = "/home/hdw/data/monk/plot/warmcorona/test/test_smooth_10_7/_exports"

OUTBASE_DEFAULT = os.path.expanduser("~/data/monk/plot/warmcorona/test/2026.01.26")
OUTSUB_DEFAULT  = "warmcom_interp_benchmark_sphere"
...
FLUX_FILE_DEFAULT = "flux_smoothed_tv.dat"
