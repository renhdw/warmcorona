...
OUTPUT_DIR = "~/data/XMM/Mrk279/0302480401/xcm"

# 两个输出文件名（slab / sphere 各一份）
XCM_SLAB   = "fit_model_Tom_slab_Mrk279.xcm"
XCM_SPHERE = "fit_model_tv_Tom_sphere_Mrk279.xcm"
...
params = [
    1,          # zTBabs:nH
    0.03015192, # zTBabs:Redshift (frozen)
    1.3E-2,    # TBabs:nH (frozen)
    1.5,        # nthComp:Gamma
    100,        # nthComp:kT_e
