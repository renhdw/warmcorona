...
# 目标目录（Linux 路径）
output_directory = "~/data/XMM/PG1116+215/0554380301/xcm"# 现在一般都在ID文件夹内，先经过SAS数据处理
output_filename = "fit_model_tv_clean_2_PG1116+215.xcm"
