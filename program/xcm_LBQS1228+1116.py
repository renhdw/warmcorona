...
OUTPUT_DIR = "~/data/XMM/LBQS1228+1116/0306630201/xcm"

# 两个输出文件名（slab / sphere 各一份）
XCM_SLAB   = "fit_model_Tom_slab_LBQS1228+1116.xcm"
XCM_SPHERE = "fit_model_tv_Tom_sphere_LBQS1228+1116.xcm"
...
params = [
    1,          # zTBabs:nH
    0.23557, # zTBabs:Redshift (frozen)
    2.35E-2,    # TBabs:nH (frozen)
    1.5,        # nthComp:Gamma
    100,        # nthComp:kT_e
