...
OUTPUT_DIR = "~/data/XMM/ESO198-G24/0067190101/xcm"

# 两个输出文件名（slab / sphere 各一份）
XCM_SLAB   = "fit_model_Tom_slab_ESO198-G24.xcm"
XCM_SPHERE = "fit_model_tv_Tom_sphere_ESO198-G24.xcm"
...
params = [
    1,          # zTBabs:nH
    0.04526328, # zTBabs:Redshift (frozen)
    2.68E-2,    # TBabs:nH (frozen)
    1.5,        # nthComp:Gamma
    100,        # nthComp:kT_e
