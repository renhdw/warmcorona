...
一次生成 3 页 PDF：tetest / tautest 相对 FULL 的对比（warmcom sphere）。
...
XSPEC 模型：
  包名/目录：
    warmcom_sphere
    warmcom_sphere_tetest
    warmcom_sphere_tautest
  mo 名称：
    warmcomsphere
    warmcomspheretetest
    warmcomspheretautest
...
# Paths (YOU)
# =========================
OUT_DIR = os.path.expanduser("~/data/monk/plot/warmcorona/test/2026.01.26/warmcom_2tests_warmcom_sphere")
...
def main():
    ...
    with PdfPages(out_pdf) as pdf:
        ...
        plot_page(
            ...
            "warmcomspheretetest (XSPEC)", "warmcomsphere FULL (XSPEC)",
        ...
        plot_page(
            ...
            "warmcomspheretautest (XSPEC)", "warmcomsphere FULL (XSPEC)",
        ...
        plot_page(
            ...
            "warmcomsphere FULL (XSPEC)", "warmcomsphere FULL (XSPEC)",
