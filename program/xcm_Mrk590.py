...
OUTPUT_DIR = "~/data/XMM/Mrk590/0201020201/xcm"

# 两个输出文件名（slab / sphere 各一份）
XCM_SLAB   = "fit_model_Tom_slab_Mrk590.xcm"
XCM_SPHERE = "fit_model_tv_Tom_sphere_Mrk590.xcm"
...
params = [
    1,          # zTBabs:nH
    0.02647065, # zTBabs:Redshift (frozen)
    2.8E-2,    # TBabs:nH (frozen)
    1.5,        # nthComp:Gamma
    100,        # nthComp:kT_e
