...
OUTPUT_DIR = "~/data/XMM/HE1029-1401/0203770101/xcm"

# 两个输出文件名（slab / sphere 各一份）
XCM_SLAB   = "fit_model_Tom_slab_HE1029-1401.xcm"
XCM_SPHERE = "fit_model_tv_Tom_sphere_HE1029-1401.xcm"
...
params = [
    1,          # zTBabs:nH
    0.08519689, # zTBabs:Redshift (frozen)
    5.74E-2,    # TBabs:nH (frozen)
    1.5,        # nthComp:Gamma
    100,        # nthComp:kT_e
