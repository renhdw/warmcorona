...
# 目标目录（Linux 路径）
output_directory = "~/data/XMM/RE1034+396/0865011801/xcm"# 现在一般都在ID文件夹内，先经过SAS数据处理
output_filename = "fit_model_tv_clean_2_RE1034+396.xcm"
