...
✅ REF 定义（warmcom 版本）：
   - 第一张图（FULL=warmcomslab）：REF = FULL（err = |1 - FULL/FULL| ~ 0，仅 sanity check）
...
# Defaults (YOU)
# =========================
OUT_DIR_DEFAULT = os.path.expanduser("~/data/monk/plot/warmcorona/test/2026.01.26/warmcom_validate_3models_heatmaps_v2/log")

MODEL_BASEDIR = os.path.expanduser("~/data/monk/plot/warmcorona/model/warmcom/warmcom_slab_log")
...
def main():
    ...
    err_mats = {}
    flux_mats = {}
    flux_mats["warmcomslab(FULL)"] = Ffull_mat
